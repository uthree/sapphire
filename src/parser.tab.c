...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PERIOD = 9,                     /* PERIOD  */
  YYSYMBOL_COMMA = 10,                     /* COMMA  */
  YYSYMBOL_COLON = 11,                     /* COLON  */
  YYSYMBOL_SEMICOLON = 12,                 /* SEMICOLON  */
  YYSYMBOL_LESSTHAN = 13,                  /* LESSTHAN  */
  YYSYMBOL_GREATERTHAN = 14,               /* GREATERTHAN  */
  YYSYMBOL_LEFT_PARENTHESIS = 15,          /* LEFT_PARENTHESIS  */
  YYSYMBOL_RIGHT_PARENTHESIS = 16,         /* RIGHT_PARENTHESIS  */
  YYSYMBOL_LEFT_BLACKET = 17,              /* LEFT_BLACKET  */
  YYSYMBOL_RIGHT_BLACKET = 18,             /* RIGHT_BLACKET  */
  YYSYMBOL_LEFT_CURLY_BLACKET = 19,        /* LEFT_CURLY_BLACKET  */
  YYSYMBOL_RIGHT_CURLY_BLACKET = 20,       /* RIGHT_CURLY_BLACKET  */
  YYSYMBOL_EQUAL_EQUAL = 21,               /* EQUAL_EQUAL  */
  YYSYMBOL_LESSTHAN_EQUAL = 22,            /* LESSTHAN_EQUAL  */
  YYSYMBOL_GREATERTHAN_EQUAL = 23,         /* GREATERTHAN_EQUAL  */
  YYSYMBOL_NOT_EQUAL = 24,                 /* NOT_EQUAL  */
  YYSYMBOL_PULS_EQUAL = 25,                /* PULS_EQUAL  */
  YYSYMBOL_MINUS_EQUAL = 26,               /* MINUS_EQUAL  */
  YYSYMBOL_ASTERISK_EQUAL = 27,            /* ASTERISK_EQUAL  */
  YYSYMBOL_SLASH_EQUAL = 28,               /* SLASH_EQUAL  */
  YYSYMBOL_NEWLINE = 29,                   /* NEWLINE  */
  YYSYMBOL_KW_AND = 30,                    /* KW_AND  */
  YYSYMBOL_KW_OR = 31,                     /* KW_OR  */
  YYSYMBOL_KW_NOT = 32,                    /* KW_NOT  */
  YYSYMBOL_KW_XOR = 33,                    /* KW_XOR  */
  YYSYMBOL_KW_NAND = 34,                   /* KW_NAND  */
  YYSYMBOL_LW_NOR = 35,                    /* LW_NOR  */
  YYSYMBOL_KW_IMPORT = 36,                 /* KW_IMPORT  */
  YYSYMBOL_KW_FROM = 37,                   /* KW_FROM  */
  YYSYMBOL_KW_AS = 38,                     /* KW_AS  */
  YYSYMBOL_KW_CLASS = 39,                  /* KW_CLASS  */
  YYSYMBOL_KW_FUNCTION = 40,               /* KW_FUNCTION  */
  YYSYMBOL_KW_CONSTRUCTOR = 41,            /* KW_CONSTRUCTOR  */
  YYSYMBOL_KW_GETTER = 42,                 /* KW_GETTER  */
  YYSYMBOL_KW_SETTER = 43,                 /* KW_SETTER  */
  YYSYMBOL_KW_IF = 44,                     /* KW_IF  */
  YYSYMBOL_KW_ELSE = 45,                   /* KW_ELSE  */
  YYSYMBOL_KW_END = 46,                    /* KW_END  */
  YYSYMBOL_KW_WHILE = 47,                  /* KW_WHILE  */
...
static const char *const yytname[] =
{
  ...
  "LEFT_CURLY_BLACKET", "RIGHT_CURLY_BLACKET", "EQUAL_EQUAL",
  "LESSTHAN_EQUAL", "GREATERTHAN_EQUAL", "NOT_EQUAL", "PULS_EQUAL",
  "MINUS_EQUAL", "ASTERISK_EQUAL", "SLASH_EQUAL", "NEWLINE", "KW_AND",
